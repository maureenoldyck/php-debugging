...
$arr = [];
// Looping through letters only works with != not with <
...
//print the copyright --- with echo, & use idate for php dates 
...
function isLinkValid(string $link) {
    ...
    foreach ($unacceptables as $unacceptable) {
        // The position of https was the first character so == true would not work
